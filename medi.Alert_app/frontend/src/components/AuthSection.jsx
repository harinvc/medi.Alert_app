              ...
              {signedIn ? (
                ...
                <form onSubmit={handleInlineLogin} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-white text-[#0C4A3B] border border-[#0C4A3B]/30 py-3.5 rounded-2xl font-semibold text-sm hover:bg-[#E8F0EC] transition-all shadow-sm hover:shadow-md cursor-pointer mt-3"
                  >
                    Login as Guest (Demo)
                  </button>
